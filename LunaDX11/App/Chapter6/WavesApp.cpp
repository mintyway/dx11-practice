...
void WavesApp::CreateGeometryBuffers()
{
    ...
    // 동적 버퍼 생성을 위한 Desc 설정이다. D3D11_USAGE_DYNAMIC, D3D11_CPU_ACCESS_WRITE을 눈여겨 보자.
    const CD3D11_BUFFER_DESC vertexBufferDesc(static_cast<UINT>(sizeof(Vertex) * vertices.size()), D3D11_BIND_VERTEX_BUFFER, D3D11_USAGE_DYNAMIC, D3D11_CPU_ACCESS_WRITE);
