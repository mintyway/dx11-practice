...
bool Engine::InitWindow()
{
    ...
    wc.lpfnWndProc = [](HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) { return Engine::Get()->HandleMessage(hWnd, message, wParam, lParam); };
...
void Engine::UpdateFrameInfo(float deltaSeconds)
{
