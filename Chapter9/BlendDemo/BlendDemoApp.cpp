...
#include "Shaders/BlendDemoShaderPass.h"
...
{
    const std::unique_ptr<EngineBase> engine = std::make_unique<BlendDemoApp>();
...
BlendDemoApp::~BlendDemoApp() = default;

bool BlendDemoApp::Init(HINSTANCE inInstanceHandle)
{
    ...
    shaderPass = std::make_unique<BlendDemoShaderPass>(device.Get());
...
void BlendDemoApp::Update(float deltaSeconds)
{
...
void BlendDemoApp::RenderObject(
...
void BlendDemoApp::CreateGeometry()
{
    CreateLandGeometry();
    CreateWaveGeometry();
...
void BlendDemoApp::CreateLandGeometry()
{
...
void BlendDemoApp::CreateWaveGeometry()
{
...
void BlendDemoApp::CreateWireFenceGeometry()
{
